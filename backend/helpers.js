...
const e = {
  ...
  fullNameMax: 'full name cannot exceed 20 characters',
...
const postPizza = async (pizza) => {
  ...
  const result = {
    status: 201,
    data: {
      message: `Thank you for your order, ${valid.fullName || 'customer'}! Your ${sizes[valid.size]} pizza with ${
        valid.toppings?.length || 'no'
